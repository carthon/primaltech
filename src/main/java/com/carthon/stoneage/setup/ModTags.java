...
public class ModTags {
    public static final class Blocks{
        ...
        private static ITag.INamedTag<Block> mod(String path){
            return BlockTags.bind(new ResourceLocation(StoneAge.MOD_ID, path).toString());
        }

    }
    public static final class Items{
        //public static final ITag.INamedTag<Item> WORK_STUMP = forge("ores/silver");
        ...
        private static ITag.INamedTag<Item> mod(String path){
            return ItemTags.bind(new ResourceLocation(StoneAge.MOD_ID, path).toString());
        }
    }
}
